...
(function(window) {
   ...
   }, document = window.document, notSupport = {
      set : noop,
      get : noop,
      remove : noop,
      clear : noop,
   ...
   (function() {
      ...
      var prefix = "p__hack_", spfix = "m-_-c", reg1 = new RegExp("^" + prefix), reg2 = new RegExp(spfix, "g"), encode = function(key) {
